...
; 0000 0032 unsigned int digitalVal;
...
; 0000 0047 // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0048 DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(48)
	OUT  0x11,R30
; 0000 0049 // State: Bit7=T Bit6=T Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0057 // Clock value: 3.906 kHz
; 0000 0058 // Mode: Ph. correct PWM top=0x00FF
; 0000 0059 // OC1A output: Non-Inverted PWM
; 0000 005A // OC1B output: Non-Inverted PWM
; 0000 005B // Noise Canceler: Off
; 0000 005C // Input Capture on Falling Edge
; 0000 005D // Timer Period: 0.13056 s
; 0000 005E // Output Pulse(s):
; 0000 005F // OC1A Period: 0.13056 s Width: 0 us// OC1B Period: 0.13056 s Width: 0 us
...
; 0000 0064 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0065 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(4)
	OUT  0x2E,R30
...
; 0000 00A2       digitalVal=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00A3       OCR1AL=digitalVal;
	OUT  0x2A,R16
; 0000 00A4       }
	RJMP _0x6
; 0000 00A5 }
