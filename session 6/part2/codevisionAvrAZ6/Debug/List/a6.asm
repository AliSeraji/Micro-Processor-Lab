...
; 0000 0034 // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0035 DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(48)
	OUT  0x11,R30
; 0000 0036 // State: Bit7=T Bit6=T Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0044 // Clock value: 3.906 kHz
...
; 0000 004A // Timer Period: 0.13056 s
; 0000 004B // Output Pulse(s):
; 0000 004C // OC1A Period: 0.13056 s Width: 0 us// OC1B Period: 0.13056 s Width: 0 us
...
; 0000 0051 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0052 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(4)
	OUT  0x2E,R30
...
; 0000 0057 OCR1AH=0x00;
	OUT  0x2B,R30
; 0000 0058 OCR1AL=0x7F;
	LDI  R30,LOW(127)
	OUT  0x2A,R30
; 0000 0059 OCR1BH=0x00;
	LDI  R30,LOW(0)
	OUT  0x29,R30
; 0000 005A OCR1BL=0x32;
	LDI  R30,LOW(50)
	OUT  0x28,R30
; 0000 005B 
