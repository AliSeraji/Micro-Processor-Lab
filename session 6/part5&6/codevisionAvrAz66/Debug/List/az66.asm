...
; 0000 0088       {
; 0000 0089 
; 0000 008A       if(PINA.0==1){
	SBIS 0x19,0
	RJMP _0x6
; 0000 008B           for(i=0;i<12;i++)
	__GETWRN 18,19,0
_0x8:
	__CPWRN 18,19,12
	BRGE _0x9
; 0000 008C             {
; 0000 008D                 PORTD = 0x09;
	RCALL SUBOPT_0x0
; 0000 008E                 delay_ms(period);
; 0000 008F                 PORTD = 0x08;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x1
; 0000 0090                 delay_ms(period);
; 0000 0091                 PORTD = 0x0C;
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x1
; 0000 0092                 delay_ms(period);
; 0000 0093                 PORTD = 0x04;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x1
; 0000 0094                 delay_ms(period);
; 0000 0095                 PORTD = 0x06;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x1
; 0000 0096                 delay_ms(period);
; 0000 0097                 PORTD = 0x02;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x1
; 0000 0098                 delay_ms(period);
; 0000 0099                 PORTD = 0x03;
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x1
; 0000 009A                 delay_ms(period);
; 0000 009B                 PORTD = 0x01;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x1
; 0000 009C                 delay_ms(period);
; 0000 009D             }
	__ADDWRN 18,19,1
	RJMP _0x8
_0x9:
; 0000 009E             PORTD = 0x09;
	RCALL SUBOPT_0x0
; 0000 009F             delay_ms(period);
; 0000 00A0             delay_ms(1000);
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 00A1       }
; 0000 00A2       if(PINA.1==1){
_0x6:
	SBIS 0x19,1
	RJMP _0xA
; 0000 00A3         for(i=0;i<12;i++)
	__GETWRN 18,19,0
_0xC:
	__CPWRN 18,19,12
	BRGE _0xD
; 0000 00A4 		{
; 0000 00A5 			PORTD = 0x09;
	RCALL SUBOPT_0x0
; 0000 00A6 			delay_ms(period);
; 0000 00A7 			PORTD = 0x03;
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x1
; 0000 00A8 			delay_ms(period);
; 0000 00A9 			PORTD = 0x06;
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x1
; 0000 00AA 			delay_ms(period);
; 0000 00AB 			PORTD = 0x0C;
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x1
; 0000 00AC 			delay_ms(period);
; 0000 00AD 		}
	__ADDWRN 18,19,1
	RJMP _0xC
_0xD:
; 0000 00AE 		PORTD = 0x09;
	RCALL SUBOPT_0x0
; 0000 00AF 		delay_ms(period);
