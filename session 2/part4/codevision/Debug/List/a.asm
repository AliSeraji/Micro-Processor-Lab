...
_0x0:
	.DB  0x41,0x56,0x52,0x0,0x4D,0x69,0x63,0x72
	.DB  0x6F,0x63,0x6F,0x6E,0x74,0x72,0x6F,0x6C
	.DB  0x6C,0x65,0x72,0x73,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0092       lcd_gotoxy(0,0);
	...
	ST   -Y,R30
	CALL SUBOPT_0x0
; 0000 0093       lcd_putsf("AVR");
; 0000 0094       lcd_gotoxy(0,1);
; 0000 0095       lcd_puts("Microcontrollers");
	__POINTW2MN _0x6,0
	CALL _lcd_puts
; 0000 0096       for(i=1;i<=13;i++){
	__GETWRN 16,17,1
_0x8:
	__CPWRN 16,17,14
	BRGE _0x9
...
; 0000 0098         lcd_gotoxy(i,0);
	ST   -Y,R16
	CALL SUBOPT_0x0
; 0000 0099         lcd_putsf("AVR");
; 0000 009A         lcd_gotoxy(0,1);
; 0000 009B         lcd_puts("Microcontrollers");
	__POINTW2MN _0x6,17
	CALL SUBOPT_0x1
...
; 0000 009F         lcd_clear();
	CALL _lcd_clear
; 0000 00A0         lcd_gotoxy(i,0);
	ST   -Y,R16
	CALL SUBOPT_0x0
; 0000 00A1         lcd_putsf("AVR");
; 0000 00A2         lcd_gotoxy(0,1);
; 0000 00A3         lcd_puts("Microcontrollers");
	__POINTW2MN _0x6,34
	CALL SUBOPT_0x1
